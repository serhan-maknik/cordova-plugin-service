...
public class DefaultString {
    public static final String batteryTitle = "Battery Permission ";
    public static final String batteryBody = "Battery permission required for app to run in background";
    public static final String batteryButton = "Settings";

    public static final String enableGpsTitle = "Enable GPS";
    public static final String enableGpsBody = "GPS needs to be turned on";
    public static final String enableGpsButton = "Allow";

    public static final String fLocationTitle = "Forground Location Permission";
